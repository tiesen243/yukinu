        ...
        <div className="container grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="relative">
            ...
            <div className="bg-popover text-popover-foreground absolute -bottom-4 -left-4 z-20 rounded-lg p-4 shadow-lg">
              <div className="flex items-center space-x-2">
                <StarIcon className="text-warning h-4 w-4 fill-current" />
                <Typography
                  variant="caption"
                  component="small"
                  className="font-medium"
          ...
          <div>
            ...
            <div className="mb-8 space-y-4">
              <div className="flex items-start space-x-3">
                <CheckIcon className="text-success mt-0.5 size-6 flex-shrink-0" />
                <div>
              ...
              <div className="flex items-start space-x-3">
                <CheckIcon className="text-success mt-0.5 h-6 w-6 flex-shrink-0" />
                <div>
                  <Typography variant="h6" className="mb-1">
              ...
              <CardContent className="p-8">
                <div className="mb-4 flex items-center">
                  {Array.from({ length: testimonial.rating }, (_, i) => (
                    <StarIcon
                      key={i}
                      className="text-warning h-5 w-5 fill-current"
                    />
                  ))}
                </div>
