    ...
    <main>
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-4">
            {stats.map((stat) => (
              <div key={stat.label} className="text-center">
                <div className="bg-card text-card-foreground mx-auto mb-4 flex size-16 items-center justify-center rounded-full shadow-sm">
                  {stat.icon}
                </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              <div className="bg-primary/10 mt-1 rounded-full p-2">
                <TargetIcon className="text-primary h-4 w-4" />
              </div>
              <div>
                <Typography variant="h6" className="mb-1">
                  Personalized Discovery
                </Typography>
                <Typography variant="p" className="text-muted-foreground mb-0">
          ...
          {values.map((value) => (
            <Card key={value.title} className="border-0 shadow-sm">
              <CardContent className="p-8">
                <div className="bg-primary/10 mb-6 flex h-16 w-16 items-center justify-center rounded-xl">
      ...
      <section className="container py-20">
        ...
        <div className="mx-auto max-w-4xl">
          <div className="relative">
            <div className="bg-primary/20 absolute top-0 bottom-0 left-8 hidden w-0.5 md:block" />
      ...
      <section className="container py-20 text-center">
        ...
        <Typography variant="p" className="text-muted-foreground mb-8 text-xl">
        ...
        <div className="mb-12 grid gap-6 md:grid-cols-3">
          ...
          <div className="text-center">
            <div className="bg-primary/10 mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full">
              <TrendingUpIcon className="text-primary h-8 w-8" />
            </div>
            <Typography variant="h6" className="mb-2">
