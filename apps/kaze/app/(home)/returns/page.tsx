    ...
    <main className="container py-12 md:py-24">
      ...
      <div className="prose prose-lg max-w-none">
        <p>
          ...
          satisfied, you can return your item for a full refund within 30 days
          of purchase.
        </p>
        ...
        <p>
          ...
          order number and the reason for your return. We will provide you
          with a return shipping label and instructions on how to return your
          item.
        </p>
      </div>
    </main>
