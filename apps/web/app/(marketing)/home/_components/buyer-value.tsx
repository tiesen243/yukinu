...
export const BuyerValue: React.FC = () => {
  return (
    ...
    >
      ...
      <section className='flex aspect-square items-center justify-center rounded-xl border border-accent bg-accent/20 p-8 md:p-12'>
        <h3 className='sr-only'>Premium shopping experience section</h3>

        <div className='space-y-4 text-center'>
          <ShoppingBagIcon className='mx-auto size-20 text-primary/30' />
