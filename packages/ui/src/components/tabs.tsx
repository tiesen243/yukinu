  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        'group-data-[variant=outline]/tabs-list:border-transparent group-data-[variant=outline]/tabs-list:bg-transparent group-data-[variant=outline]/tabs-list:data-active:bg-input dark:group-data-[variant=outline]/tabs-list:data-active:bg-input/60',
